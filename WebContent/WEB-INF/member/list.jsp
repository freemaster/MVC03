...
<title>회원리스트 출력( ${cpath} : Model2 - front controller + POJO + HandlerMapping-HashMap )</title>
<style>
/* DivTable.com */
.divTable {
    display: table;
...
<body>
    <h4>회원목록( ${cpath} : Model2 - front controller + POJO + HandlerMapping-HashMap )</h4>
        ...
        <div class="divTableBody">
            ...
            */
            ...
            <c:forEach var="vo" items="${list}">
                ...
                <div class="divTableCell">
                    <button onclick="updateFn(${vo.num})" class="btn btn-primary">수정</button>
                    &nbsp;&nbsp;
                    <button onclick="deleteFn(${vo.num})" class="btn btn-primary">삭제</button>
                </div>
            </div>
            </c:forEach>
        </div>
    ...
    <div class="divTable2">
        <div class="divTableRow2">
            <button onclick="insertForm()" value="회원가입" class="btn btn-primary">회원가입</button>
        </div>
    </div>
